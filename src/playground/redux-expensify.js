...
const expense2 = store.dispatch(addExpense({ description: 'Coffee', amount: 300, createdAt: 100}));
const expense3 = store.dispatch(addExpense({ description: 'Tequila', amount: 400,  createdAt: 100 }));
